...
canvasGraph.height= window.innerHeight * 0.80;
canvasGraph.width = window.innerHeight * 0.80;

//declaration of global variabls
let pointsArrayX, pointsArrayY, distances, maxDistances //arrays to hold points and distances
...
function simulate() {
    ...
    p++
    document.querySelector("#result").innerHTML = "The average maximum distance for " + p + " runs is " + meanVal(maxDistances)
}
